            ...
            @foreach($students as $student)
                ...
                <tr>
                    ...
                    <th class="d-flex">
                        ...
                        <button type="button" class="btn-outline-success btn m-2" data-target="#exampleModal" data-toggle="modal" data-whatever="@mdo" style="float:right">
...
{{--                        </div>--}}
                        ...
                        <a href="{{route('student.show',$student->id)}}" class="btn-outline-warning btn m-2" style="float:right">
                        ...
                        <a href="{{route('student.edit',$student->id)}}" class="btn-outline-primary btn m-2" style="float:right">
